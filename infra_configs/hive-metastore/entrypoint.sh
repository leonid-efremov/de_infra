...
export HADOOP_CLASSPATH="/opt/hive/lib/hadoop-aws-3.3.4.jar:/opt/hive/lib/aws-java-sdk-bundle-1.12.262.jar:/opt/hive/lib/iceberg-hive-runtime-1.9.2.jar:/opt/hive/lib/hive-iceberg-catalog-4.2.0.jar:$HADOOP_CLASSPATH"
